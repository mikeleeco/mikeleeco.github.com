	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/animation.json/_server.js'))
			},
			{
				id: "/animation",
				pattern: /^\/animation\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/animation/animation.json/_server.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/posts.json/_server.js'))
			},
			{
				id: "/posts",
				pattern: /^\/posts\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/posts/posts.json/_server.js'))
			},
			{
				id: "/posts/[posts]",
				pattern: /^\/posts\/([^/]+?)\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/projects.json/_server.js'))
			},
			{
				id: "/projects",
				pattern: /^\/projects\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/projects/projects.json/_server.js'))
			},
			{
		...
		prerendered_routes: new Set(["/","/projects.json","/posts.json","/animation.json","/about","/animation","/apps","/cartoons","/contact","/license","/posts","/projects","/resume","/animation/2020-08-07-bar-chart-parent-educational-attainment","/animation/2020-07-09-racing-bar-chart-enrollment-postsecondary","/animation/2020-06-18-racing-bar-chart-enrollment-secondary","/animation/2020-06-10-state-map-percentage-ell-update","/animation/2020-05-30-line-chart-masters-degrees-conferred","/animation/2020-05-28-line-chart-college-enrollment-update","/animation/2020-05-26-bar-chart-median-annual-earnings-update","/animation/2020-04-16-racing-bar-chart-enrollment","/animation/2020-03-13-state-map-acgr-update","/animation/2019-07-05-state-map-percentage-ell","/animation/2019-06-19-bar-chart-median-annual-earnings","/animation/2019-04-19-line-chart-reported-bullying","/animation/2019-05-26-line-chart-college-enrollment","/animation/2019-04-17-line-chart-on-campus-crimes","/animation/2019-02-22-line-chart-status-dropout-rate","/animation/2019-01-24-state-map-acgr","/animation/2018-12-12-line-chart-status-completion-rate","/animation/2018-09-05-stacked-area-chart-enrollment","/animation/2018-08-18-animated-faceted-line-chart-student-loan-doctors","/animation/2018-08-07-animated-faceted-line-chart-student-loan-masters","/animation/2018-05-23-animated-line-chart-cumulative-student-loan-balance","/animation/2018-02-12-animated-line-school-revenue","/animation/2018-01-29-animated-line-chart-expenditures","/animation/2017-10-19-high-school-attainment-rates","/animation/2017-10-14-animated-bar-chart-percent-borrowers-by-cohort","/animation/2017-10-05-animated-bar-chart-twelve-year-debt","/animation/2017-09-22-animated-charter-enrollment-state-grid-map","/animation/2017-09-16-animated-line-chart-pupil-ratio","/animation/2017-09-09-animated-line-chart-bachelors-attainment","/cartoons/zoo","/cartoons/zoo/__data.json","/cartoons/sheep","/cartoons/sheep/__data.json","/cartoons/chimpanzees","/cartoons/chimpanzees/__data.json","/cartoons/racoon","/cartoons/racoon/__data.json","/cartoons/fish","/cartoons/fish/__data.json","/cartoons/bee","/cartoons/bee/__data.json","/cartoons/friendly","/cartoons/friendly/__data.json","/cartoons/mice","/cartoons/mice/__data.json","/cartoons/muzzle","/cartoons/muzzle/__data.json","/cartoons/next","/cartoons/next/__data.json","/cartoons/trash","/cartoons/trash/__data.json","/cartoons/lightbulb","/cartoons/lightbulb/__data.json","/cartoons/mrBee","/cartoons/mrBee/__data.json","/cartoons/singlesNight","/cartoons/singlesNight/__data.json","/cartoons/watching","/cartoons/watching/__data.json","/cartoons/crane","/cartoons/crane/__data.json","/cartoons/wildflowers","/cartoons/wildflowers/__data.json","/cartoons/ducklings","/cartoons/ducklings/__data.json","/cartoons/amishFarm","/cartoons/amishFarm/__data.json","/cartoons/owl","/cartoons/owl/__data.json","/cartoons/queasy","/cartoons/queasy/__data.json","/cartoons/ant","/cartoons/ant/__data.json","/cartoons/chandelier","/cartoons/chandelier/__data.json","/cartoons/nest","/cartoons/nest/__data.json","/cartoons/shark","/cartoons/shark/__data.json","/cartoons/weight","/cartoons/weight/__data.json","/cartoons/broadway","/cartoons/broadway/__data.json","/cartoons/shots","/cartoons/shots/__data.json","/cartoons/sorry","/cartoons/sorry/__data.json","/cartoons/ducky","/cartoons/ducky/__data.json","/cartoons/suits","/cartoons/suits/__data.json","/posts/2023-10-23-dc-takeoff","/posts/2020-01-21-creating-duplicate-legends","/posts/2020-01-21-left-align-ggplot2-titles-subtitles-and-footnotes","/posts/2019-02-23-creating-pauses-in-r-animations","/posts/2019-01-28-wisconsin-rushing-history","/posts/2017-07-10-makeover-monday-wsj-measles-vaccination-chart","/posts/2017-06-28-wsj-measles-vaccination-chart","/posts/2016-12-26-wisconsin-presidential-election-results","/posts/2015-02-23-milb-scraper-with-rvest","/projects/2022-02-17-edsurvey-book","/projects/2022-01-20-perc-covid-data-story","/projects/2021-01-20-IAP-TIMSS-Summary-Release","/projects/2020-03-30-NCES-Animation","/projects/2019-12-30-Automated-Report-Nevada","/projects/2019-12-02-IAP-PISA-Summary-Release","/projects/2019-11-05-IAP-ICILS-Summary-Release","/projects/2019-12-30-Teacher-Student-Shiny-Application","/projects/2019-06-28-IAP-TALIS-Summary-Release","/projects/2018-11-20-Automated-Report-Cleveland-Metropolitan-School-District","/projects/2018-05-09-Automated-Reports-Public-Library-Services","/projects/2017-06-03-EdSurvey-R-package","/projects/2017-06-03-NAEPprimer-R-package","/projects/2016-05-28-sabr-R-package"]),
		matchers: async () => {
