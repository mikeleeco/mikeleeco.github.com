...
function Footer($$payload) {
  ...
  Logo($$payload);
  $$payload.out += `<!----></div> <div class="grid grid-cols-2 flex-col gap-5 sm:grid-cols-4"><a class="link flex flex-row gap-1" target="_blank" aria-label="footer-link" rel="noopener noreferrer" href="https://www.linkedin.com/in/mikeleeco/">`;
