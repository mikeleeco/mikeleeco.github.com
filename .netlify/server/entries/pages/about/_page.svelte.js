...
function _page($$payload) {
  ...
  ContainerLayout($$payload, {
    children: ($$payload2) => {
      $$payload2.out += `<div class="grid gap-5"><h1>About Michael Lee</h1> <p>I’m a full-stack developer with an interest in creating cross-platform applications. Crabapple
			...
			background in special education assists in making complex concepts accessible. Check out my <a href="/resume">resume</a> and scroll through my <a href="/projects">projects</a> and <a href="/animation">data visualization</a> products.</p> <div><h2>License</h2> Visit the <a target="_blank" aria-label="footer-link" rel="noopener noreferrer" href="/license">License</a> page for more information about the content of this website.</div> <div><h2>Contact</h2> <p>Interested in learning more? <a href="/contact">Contact me</a> to draw a cartoon or consult on
				your next project.</p></div></div>`;
    }
  });
  $$payload.out += `<!---->`;
}
