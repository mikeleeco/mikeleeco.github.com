		...
		<div class="modal-body">
			<form class="form-horizontal" name="commentform" method="POST" action="http://formspree.io/mdlee12@gmail.com">
			 ...
			 <div class="form-group">
				...
				<div class="col-md-6">
				    <input type="text" class="form-control .has-error" id="name" name="name" placeholder="Name" />
				...
				<span class="input-group-addon">@</span>
				    <input type="email" class="form-control .has-error" id="email" name="email" placeholder="Email Address" data-fv-emailaddress-message="The value is not a valid email address"/>
				    <span class="glyphicon glyphicon-ok form-control-feedback"></span>
				</div>
			    </div>
			    <div class="form-group">
				...
				<div class="col-md-6">
				    <input type="text" textarea rows="6" class="form-control .has-error" id="comments" name="comments" placeholder="Your question or comment here"></textarea>
				    <span class="glyphicon glyphicon-ok form-control-feedback"></span>
				</div>
			    </div>
			    <div class="form-group">
