...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, dpi = 180, fig.height = 7, fig.width = 10, fig.align = "center")
...
```{r hexmapr shape exploring, results='hide'}
...
```{r hexmapr assign polygons and clean, results='hide'}
library(dplyr)
library(ggplot2)
