...
subtitle: "A Guide to the video game rating system using interactive visuals - Theme"
tags: [MobyGames, Video Games, FiveThirtyEight, data, R, ggplot2, rvest, D3.js]
date: 2015-06-10
comments: true
hidden: true
categories: ["interactives"]
description: "An interactive heatmap visualizing the MobyGames videogames database by theme."
bigimg: [{src: "/img/theme_interactive.png", desc: "Theme Interactive"}]
---
